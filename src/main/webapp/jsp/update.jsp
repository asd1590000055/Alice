...
<body>
<form method="post" action="${app}/article/insert">
    <br>
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="title" value="${requestScope.article.title}"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="layout">
        <div id="test-editormd">
            <textarea style="display:none;" name="content">${requestScope.article.content}</textarea>
        </div>
    </div>
